export const metadata = {
  title: "Obrigado — Compass Relatório Básico",
  description:
    "Sua compra do Relatório Básico foi confirmada. Preencha o questionário para receber seu relatório Compass personalizado.",
};

const QUESTIONNAIRE_URL = "https://tally.so/r/0QlOb9";

export default function ThankYouBasicoPage() {
  return (
    <>
      <style>{`
      ...
      <div className="thankyou-page">
        ...
        <main className="thankyou-main">
          <div className="thankyou-card">
            <span className="thankyou-label">Relatório Básico</span>
            <h1>Obrigado — está confirmado.</h1>
            <p>
              Sua compra foi confirmada. O próximo passo é o questionário de 5
              minutos — tudo no seu relatório é construído com base nas suas
              respostas.
            </p>
            ...
            <ol className="thankyou-steps">
              ...
              <li>
                ...
                <div className="thankyou-step-text">
                  ...
                  <span>
                    Responda abaixo — leva cerca de 5 minutos e é a única coisa
                    que precisamos para construir seu relatório. Um link também
                    foi enviado para sua caixa de entrada caso queira retornar
                    depois.
                    <br />
                    <a
              ...
              <li>
                ...
                <div className="thankyou-step-text">
                  ...
                  <span>
                    Seu Relatório Básico personalizado chegará na sua caixa de
                    entrada em 3–5 dias.
                  </span>
                </div>
              </li>
