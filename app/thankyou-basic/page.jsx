export const metadata = {
  title: "Thank You — Compass Basic Report",
  description:
    "Your Basic Report purchase is confirmed. Complete your questionnaire to receive your personalised Compass report.",
};

export default function ThankYouBasicPage() {
  return (
    <>
      <style>{`
      ...
      <div className="thankyou-page">
        ...
        <main className="thankyou-main">
          <div className="thankyou-card">
            <span className="thankyou-label">Basic Report</span>
            <h1>Thank you — you&apos;re in.</h1>
            <p>
              Your purchase is confirmed. The next step is your 5-minute
            ...
            <ol className="thankyou-steps">
              ...
              <li>
                ...
                <div className="thankyou-step-text">
                  ...
                  <span>
                    Your personalised Basic Report will arrive in your inbox
                    within 3–5 days.
                  </span>
                </div>
              </li>
